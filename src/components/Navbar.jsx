      ...
      <div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
        <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
          ...
          >
            ...
            <span><a href="/mileage">Milege</a></span>
          </button>
          <div
            id="tooltip-wallet"
            role="tooltip"
          ...
          <a href="/addtrip"> 
            <button
              ...
              type="button"
              class="inline-flex items-center justify-center w-10 h-10 font-medium bg-purple-600 rounded-full hover:bg-purple-600 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800"
            >
              <svg
          ...
          >
            ...
            <span><a href="/tripinfo"> TripInfo</a></span>
          </button>
          <div
            id="tooltip-settings"
            role="tooltip"
